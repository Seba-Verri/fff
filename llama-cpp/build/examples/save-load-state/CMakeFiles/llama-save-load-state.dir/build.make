...
examples/save-load-state/CMakeFiles/llama-save-load-state.dir/save-load-state.cpp.o: /home/utente/Downloads/llama.cpp/examples/save-load-state/save-load-state.cpp
examples/save-load-state/CMakeFiles/llama-save-load-state.dir/save-load-state.cpp.o: examples/save-load-state/CMakeFiles/llama-save-load-state.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --progress-dir=/home/utente/Downloads/llama.cpp/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object examples/save-load-state/CMakeFiles/llama-save-load-state.dir/save-load-state.cpp.o"
	cd /home/utente/Downloads/llama.cpp/build/examples/save-load-state && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -MD -MT examples/save-load-state/CMakeFiles/llama-save-load-state.dir/save-load-state.cpp.o -MF CMakeFiles/llama-save-load-state.dir/save-load-state.cpp.o.d -o CMakeFiles/llama-save-load-state.dir/save-load-state.cpp.o -c /home/utente/Downloads/llama.cpp/examples/save-load-state/save-load-state.cpp
...
examples/save-load-state/CMakeFiles/llama-save-load-state.dir/save-load-state.cpp.i: cmake_force
	...
	cd /home/utente/Downloads/llama.cpp/build/examples/save-load-state && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /home/utente/Downloads/llama.cpp/examples/save-load-state/save-load-state.cpp > CMakeFiles/llama-save-load-state.dir/save-load-state.cpp.i
...
examples/save-load-state/CMakeFiles/llama-save-load-state.dir/save-load-state.cpp.s: cmake_force
	...
	cd /home/utente/Downloads/llama.cpp/build/examples/save-load-state && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /home/utente/Downloads/llama.cpp/examples/save-load-state/save-load-state.cpp -o CMakeFiles/llama-save-load-state.dir/save-load-state.cpp.s
...
bin/llama-save-load-state: examples/save-load-state/CMakeFiles/llama-save-load-state.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --bold --progress-dir=/home/utente/Downloads/llama.cpp/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/llama-save-load-state"
	cd /home/utente/Downloads/llama.cpp/build/examples/save-load-state && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/llama-save-load-state.dir/link.txt --verbose=$(VERBOSE)
...
examples/save-load-state/CMakeFiles/llama-save-load-state.dir/clean:
	cd /home/utente/Downloads/llama.cpp/build/examples/save-load-state && $(CMAKE_COMMAND) -P CMakeFiles/llama-save-load-state.dir/cmake_clean.cmake
...
examples/save-load-state/CMakeFiles/llama-save-load-state.dir/depend:
	cd /home/utente/Downloads/llama.cpp/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /home/utente/Downloads/llama.cpp /home/utente/Downloads/llama.cpp/examples/save-load-state /home/utente/Downloads/llama.cpp/build /home/utente/Downloads/llama.cpp/build/examples/save-load-state /home/utente/Downloads/llama.cpp/build/examples/save-load-state/CMakeFiles/llama-save-load-state.dir/DependInfo.cmake "--color=$(COLOR)"
